...
This [module](./geo/README.md) can be used to get geo information (like country or city) of a location identified by latitude and longitude. This is possible both offline and over https using Nominatim or Photon.
